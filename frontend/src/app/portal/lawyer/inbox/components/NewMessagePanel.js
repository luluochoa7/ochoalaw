      ...
      >
        <div>
          ...
          <select
            ...
            className="mt-2 w-full rounded-lg border border-slate-300 px-3 py-2.5 text-sm text-slate-800 shadow-sm focus:border-[#245B83] focus:ring-[#245B83] disabled:bg-slate-100 disabled:text-slate-500"
          >
            <option value="">
        ...
        <div>
          ...
          <textarea
            ...
            maxLength={5000}
            className="mt-2 min-h-[160px] w-full resize-none rounded-lg border border-slate-300 px-4 py-3 text-sm text-slate-800 shadow-sm placeholder:text-slate-400 focus:border-[#245B83] focus:ring-[#245B83]"
          />
        </div>
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:justify-end">
          ...
          <button
            ...
            className="rounded-lg bg-[#245B83] px-4 py-2.5 text-sm font-medium text-white hover:bg-[#183F5F] disabled:cursor-not-allowed disabled:opacity-60"
          >
